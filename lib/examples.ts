...
export const EXAMPLES = [
 ...
 {id:'planned',label:'看看规划能力',input:'每天19点，播放QQ音乐我喜欢的列表'},
];
export function exampleScene(id:string,ctx:Context):Scene {
 ...
 if(id==='planned')return {...s,intent:'precise',name:'晚间旋律',understanding:'“每天19点，播放我喜欢的列表”，为这个时刻留一段音乐。',conditions:[{primary:'生效时间',op:'==',secondary:'19:00'},{primary:'重复周期',op:'==',secondary:'每天'}],actions:[{primary:'QQ音乐',secondary:'我喜欢列表'}]};
 if(id==='simple')return {...s,intent:'action',name:'光和温度',understanding:'“把灯调暗、温度24度”，只安排这两项。',actions:[{primary:'氛围灯亮度',secondary:'20%'},{primary:'主驾温度控制',secondary:'24℃'}]};
