  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="上海徐汇滨江地图，标出龙腾大道、黄浦江和龙美术馆西岸馆"
      ...
      <div className="absolute left-10 top-24 w-[280px] rounded-2xl border border-white/[0.07] bg-card/90 p-5 shadow-xl shadow-black/20 backdrop-blur-xl">
        <div className="flex items-center gap-2 text-[11px] tracking-[0.18em] text-muted-foreground">
          <MapPin className="h-3.5 w-3.5 text-primary" /> SHANGHAI · WEST BUND
        </div>
        <div className="mt-3 text-[26px] tracking-tight text-foreground">
          徐汇滨江
        </div>
        <div className="mt-1 flex items-center gap-2 text-[14px] text-muted-foreground">
          <span className="h-0.5 w-5 rounded bg-primary" /> 龙腾大道 · 西岸街区
        </div>
        <div className="mt-4 border-t border-white/[0.06] pt-3 text-[11px] text-muted-foreground/70">
          真实街区 · 静态地图 · 非实时导航
        </div>
      </div>
      <div
      ...
      <div className="absolute bottom-5 left-8 z-10 flex items-center gap-2 text-[11px] text-muted-foreground/80">
        <a
